...
function Meme(){
    ...
    return(
        <>
            <div className='form'>
                <input type="text" name="topText" value={meme.topText} className='form--input' id="meme_uppertext" placeholder='Top text' onChange={handleChange} />
                <input type="text" name="bottomText" value={meme.bottomText} className='form--input' id="meme_lowertext" placeholder='Bottom text' onChange={handleChange} />

                <button className='form--button' onClick={getMemesImage}>Get a new Meme Image 🖼️</button>
            </div>
